      ...
      <div className="flex flex-col flex-grow p-6">
        ...
        <div className="mt-auto pt-4 border-t border-gray-100 dark:border-gray-800">
          <div className="flex flex-wrap gap-4 items-center">
            {/* View Details link if PDF or subProjects exist */}
            ...
            {project.academicProject && !project.pdfUrl && !project.subProjects && (
            ...
            {links && links.length > 0 && (
              <>
                {links.slice(0, (project.pdfUrl || project.subProjects) ? 1 : 2).map((link, index) => (
                  <a
                    key={index}
                    href={link.url}
                    target="_blank"
